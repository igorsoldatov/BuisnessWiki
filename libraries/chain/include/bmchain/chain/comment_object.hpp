...
FC_REFLECT( bmchain::chain::comment_object,
             (id)(author)(permlink)
...
FC_REFLECT( bmchain::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)(comment_bmchain)
          )
CHAINBASE_SET_INDEX_TYPE( bmchain::chain::comment_vote_object, bmchain::chain::comment_vote_index )
