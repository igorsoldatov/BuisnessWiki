...
namespace bmchain { namespace chain {
   ...
   using bmchain::protocol::chain_properties;
   using bmchain::protocol::digest_type;
   using bmchain::protocol::public_key_type;
   using bmchain::protocol::version;
   using bmchain::protocol::hardfork_version;
...
FC_REFLECT( bmchain::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( bmchain::chain::witness_vote_object, bmchain::chain::witness_vote_index )
...
CHAINBASE_SET_INDEX_TYPE( bmchain::chain::witness_schedule_object, bmchain::chain::witness_schedule_index )
