...
void withdraw_savings_evaluator::do_apply( const withdraw_savings_operation& o )
{
   ...
   FC_ASSERT(account.savings_balance >= asset(0, BWC_SYMBOL),
   ...
   if (o.savings.amount == 0) {
      ...
      _db.modify(account, [&](account_object &a) {
         a.savings_withdraw_rate = asset(0, BWC_SYMBOL);
      ...
      _db.modify(account, [&](account_object &a) {
         auto new_savings_withdraw_rate = asset(o.savings.amount / vesting_withdraw_intervals, BWC_SYMBOL);
