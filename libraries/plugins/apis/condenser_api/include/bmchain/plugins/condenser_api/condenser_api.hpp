...
#include <bmchain/plugins/database_api/database_api.hpp>
#include <bmchain/plugins/block_api/block_api.hpp>
#include <bmchain/plugins/account_history_api/account_history_api.hpp>
#include <bmchain/plugins/account_by_key_api/account_by_key_api.hpp>
#include <bmchain/plugins/network_broadcast_api/network_broadcast_api.hpp>
#include <bmchain/plugins/tags_api/tags_api.hpp>
#include <bmchain/plugins/follow_api/follow_api.hpp>
#include <bmchain/plugins/reputation_api/reputation_api.hpp>
#include <bmchain/plugins/market_history_api/market_history_api.hpp>

#include <bmchain/plugins/condenser_api/condenser_api_legacy_objects.hpp>
...
struct api_account_object
{
   api_account_object( const database_api::api_account_object& a ) :
      ...
      reward_bmt_balance( legacy_asset::from_asset( a.reward_bmt_balance ) ),
   ...
   legacy_asset      reward_bmt_balance;
...
struct api_comment_object
{
   api_comment_object( const database_api::api_comment_object& c ):
      ...
      percent_steem_doll( c.percent_steem_doll ),
...
struct extended_dynamic_global_properties
{
   ...
   uint32_t          vote_power_reserve_rate = BMCHAIN_INITIAL_VOTE_POWER_RATE;
   uint32_t          delegation_return_period = BMCHAIN_DELEGATION_RETURN_PERIOD_HF0;
...
struct api_escrow_object
{
   ...
   api_escrow_object( const database_api::api_escrow_object& e ) :
      ...
      bmt_balance( legacy_asset::from_asset( e.bmt_balance ) ),
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v )
      :blockchain_version( bc_v ), bmt_revision( s_v ), fc_revision( fc_v ) {}

   fc::string blockchain_version;
   fc::string bmt_revision;
...
struct ticker
{
   ...
   ticker( const market_history::get_ticker_return& t ) :
      ...
      bmt_volume( legacy_asset::from_asset( t.bmt_volume ) ),
...
struct volume
{
   ...
   volume( const market_history::get_volume_return& v ) :
      bmt_volume( legacy_asset::from_asset( v.bmt_volume ) ),
...
FC_REFLECT( bmchain::plugins::condenser_api::discussion_index,
...
FC_REFLECT( bmchain::plugins::condenser_api::api_account_object,
             ...
             (vesting_shares)(delegated_vesting_shares)(received_vesting_shares)(savings_withdraw_rate)(next_vesting_withdrawal)(withdrawn)(to_withdraw)(withdraw_routes)
             (curation_rewards)
             (posting_rewards)
...
FC_REFLECT_DERIVED( bmchain::plugins::condenser_api::extended_account, (bmchain::plugins::condenser_api::api_account_object),
...
FC_REFLECT( bmchain::plugins::condenser_api::api_comment_object,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_steem_doll)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( bmchain::plugins::condenser_api::extended_dynamic_global_properties,
...
FC_REFLECT( bmchain::plugins::condenser_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( bmchain::plugins::condenser_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT( bmchain::plugins::condenser_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( bmchain::plugins::condenser_api::api_reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
FC_REFLECT( bmchain::plugins::condenser_api::api_escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (sbd_balance)(bmt_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )

FC_REFLECT( bmchain::plugins::condenser_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( bmchain::plugins::condenser_api::api_vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )

FC_REFLECT( bmchain::plugins::condenser_api::api_vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )

FC_REFLECT( bmchain::plugins::condenser_api::api_convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )

FC_REFLECT_DERIVED( bmchain::plugins::condenser_api::discussion, (bmchain::plugins::condenser_api::api_comment_object),
...
FC_REFLECT( bmchain::plugins::condenser_api::scheduled_hardfork,
            (hf_version)(live_time) )

FC_REFLECT( bmchain::plugins::condenser_api::account_vote,
            (authorperm)(weight)(rshares)(percent)(time) )

FC_REFLECT( bmchain::plugins::condenser_api::tag_index, (trending) )

FC_REFLECT_ENUM( bmchain::plugins::condenser_api::withdraw_route_type, (incoming)(outgoing)(all) )

FC_REFLECT( bmchain::plugins::condenser_api::get_version_return,
            (blockchain_version)(bmt_revision)(fc_revision) )

FC_REFLECT( bmchain::plugins::condenser_api::broadcast_transaction_synchronous_return,
            (id)(block_num)(trx_num)(expired) )

FC_REFLECT( bmchain::plugins::condenser_api::comment_feed_entry,
            (comment)(reblog_by)(reblog_on)(entry_id) )

FC_REFLECT( bmchain::plugins::condenser_api::comment_blog_entry,
            (comment)(blog)(reblog_on)(entry_id) )

FC_REFLECT( bmchain::plugins::condenser_api::ticker,
            (latest)(lowest_ask)(highest_bid)(percent_change)(bmt_volume)(sbd_volume) )

FC_REFLECT( bmchain::plugins::condenser_api::volume,
            (bmt_volume)(sbd_volume) )

FC_REFLECT( bmchain::plugins::condenser_api::order,
            (order_price)(real_price)(steem)(sbd)(created) )

FC_REFLECT( bmchain::plugins::condenser_api::order_book,
            (bids)(asks) )

FC_REFLECT( bmchain::plugins::condenser_api::market_trade,
