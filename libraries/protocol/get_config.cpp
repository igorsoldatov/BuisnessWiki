...
fc::variant_object get_config()
{
   ...
   result["BMCHAIN_DEFAULT_EMISSION_RATE"] = BMCHAIN_DEFAULT_EMISSION_RATE;
   ...
   result["BMCHAIN_MIN_CURATION_PERCENT"] = BMCHAIN_MIN_CURATION_PERCENT;
   result["BMCHAIN_DEF_CURATION_PERCENT"] = BMCHAIN_DEF_CURATION_PERCENT;
   result["BMCHAIN_MAX_CURATION_PERCENT"] = BMCHAIN_MAX_CURATION_PERCENT;
