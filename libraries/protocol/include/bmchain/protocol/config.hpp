...
#define BMCHAIN_SAVINGS_REWARD_INTERVAL_BLOCKS	20 // (20*60*24*30) /// 30 days
...
#define BMCHAIN_SAVINGS_WITHDRAW_INTERVALS        2 // 30
#define BMCHAIN_SAVINGS_WITHDRAW_INTERVAL_SECONDS 60 // (60*60*24*7) /// 1 week per interval
