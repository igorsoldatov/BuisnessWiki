...
#define BMCHAIN_START_VESTING_BLOCK             (BMCHAIN_BLOCKS_PER_DAY * 7)
...
#define BMCHAIN_MAX_TIME_UNTIL_EXPIRATION       (60*60) // seconds,  aka: 1 hourwithdraw_savings_evaluator
...
#define BMCHAIN_SAVINGS_REWARD_INTERVAL_BLOCKS	(20*60*24*30) /// 30 days
...
#define BMCHAIN_DAILY_INFLATION_RATE_RESTRICTION 20

#define BMCHAIN_SAVINGS_EMISSION_RATE             20 /// 20% from emission
#define BMCHAIN_SAVINGS_WITHDRAW_INTERVALS        30
#define BMCHAIN_SAVINGS_WITHDRAW_INTERVAL_SECONDS (60*60*24*7) /// 1 week per interval
