...
namespace bmchain { namespace protocol {
   ...
   {
      FC_ASSERT( permlink.size() < BMCHAIN_MAX_PERMLINK_LENGTH, "permlink is too long" );
...
FC_REFLECT( bmchain::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( bmchain::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( bmchain::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( bmchain::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( bmchain::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( bmchain::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( bmchain::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( bmchain::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( bmchain::protocol::pow, (worker)(input)(signature)(work) )
...
FC_REFLECT( bmchain::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( bmchain::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( bmchain::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( bmchain::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( bmchain::protocol::extended_encrypted_content, (to_memo_key)(from_memo_key)(checksum)(encrypted_body) )
FC_REFLECT( bmchain::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( bmchain::protocol::vote_operation, (voter)(author)(permlink)(weight)(comment_bmchain) )
FC_REFLECT( bmchain::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( bmchain::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( bmchain::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( bmchain::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
